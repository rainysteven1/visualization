...
docker run -itd --name master --network spark-net --ip 172.20.0.2 -h master -p 18088:8088 -p 18888:8888 -p 51070:50070 -p 17077:7077 -p 19000:9000 -p 28080:18080 -p 14040:4040 --add-host worker1:172.20.0.3 --add-host worker1:172.20.0.4 --add-host mysql:172.20.0.5 bigdata:$1
